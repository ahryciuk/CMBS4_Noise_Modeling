...
def S4_noise(band_centers=[27.,39.,93.,145.,225.,280.], beam_sizes=[7.4,5.1,2.2,1.4,1.0,0.9], Sens=[48.,24.,5.4,6.7,15.,36.], ell_max=1e4, f_knees=[700.,700.,700.,700.,700.,700.], Cs=[200,7.7,1800,12000,68000,124000], alpha_temp=-3.5, survey_time=5., f_sky=0.4, ret_after_obs_cuts=0.2, non_uniformity_param=0.85, ell_pivot=1000.,delta_ell=5,alpha_pol=0.4,NTubes_LF=1, NTubes_MF=4,NTubes_UHF=2):
...
#    N_ell_T_225x280 *= np.exp( (ell*(ell+1)/2.) * (LA_beams[4]**2. + LA_beams[5]**2.) )
    ...
    for i in range(0,len(N_ell_P),2):
